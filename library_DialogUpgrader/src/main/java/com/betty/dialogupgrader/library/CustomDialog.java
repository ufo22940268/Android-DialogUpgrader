...
public class CustomDialog extends AlertDialog {
    ...
    public CustomDialog(LDialogBuilder _LDialog_builder) {
        super(new ContextThemeWrapper(_LDialog_builder.mContext, _LDialog_builder.mDarkTheme ? android.R.style.Theme_Holo : android.R.style.Theme_Holo_Light));
        mContext = _LDialog_builder.mContext;
        init();
        setIsDarkTheme(_LDialog_builder.mDarkTheme);
        setTitle(_LDialog_builder.mTitle);
        setContent(_LDialog_builder.mContent);
        setConfirm(_LDialog_builder.mPositiveText);
        setCancel(_LDialog_builder.mNegativeText);
        setConfirmColour(_LDialog_builder.mPositiveColour);
    }
    ...
    private void init() {
        ...
        mViews[2] = mRootView.findViewById(android.R.id.button1);
        mViews[3] = mRootView.findViewById(android.R.id.button2);
    ...
    private void updateButtonReferences(boolean _isStackingNeeded) {
        mViews[2] = mRootView.findViewById(_isStackingNeeded ? R.id.dialog_custom_confirm_stacked : android.R.id.button1);
        mViews[3] = mRootView.findViewById(_isStackingNeeded ? R.id.dialog_custom_cancel_stacked : android.R.id.button2);
